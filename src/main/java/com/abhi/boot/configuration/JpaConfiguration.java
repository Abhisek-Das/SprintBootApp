package com.abhi.boot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.abhi.boot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.abhi.boot.model" });
	...
	private Properties jpaProperties() {
		...
		properties.put("hibernate.jdbc.lob.non_contextual_creation", environment.getRequiredProperty("datasource.sampleapp.hibernate.jdbc.lob.non_contextual_creation"));
